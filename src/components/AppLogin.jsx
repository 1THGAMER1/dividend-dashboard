  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ color: '#7a8ba0', fontSize: 13, textAlign: 'center', marginTop: 20 }}>
          {mode === 'login' ? 'Noch kein Account?' : 'Bereits registriert?'}{' '}
          <button
            onClick={() => { setMode(mode === 'login' ? 'register' : 'login'); setError(null); setInfo(null) }}
            style={{ background: 'none', border: 'none', color: '#009991', cursor: 'pointer', fontSize: 13, fontWeight: 600 }}
          >
